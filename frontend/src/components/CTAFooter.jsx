...
const CTAFooter = () => {
  ...
  return (
    <div className="relative bg-[#0A1931] border-t border-[#1A3D63]/20">
      {/* Final CTA Section */}
      <section 
        id="join" 
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[550px] bg-gradient-to-tr from-[#1A3D63]/20 via-[#1A3D63]/15 to-[#1A3D63]/20 rounded-full blur-[160px]" />
          <div className="absolute inset-0 cyber-grid opacity-30" />
        </div>

        <div className="relative z-10 max-w-5xl mx-auto px-6 sm:px-8 text-center flex flex-col items-center">
          <Reveal animation="fade-down">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#1A3D63]/80 border border-[#1A3D63]/40 text-[#B3CFE5] text-xs sm:text-sm font-mono uppercase tracking-wider mb-6 shadow-md backdrop-blur-md">
      ...
      <footer className="relative z-10 border-t border-[#1A3D63]/30 bg-[#0A1931] py-6 px-6 sm:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          {/* Logo & Team */}
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-[#1A3D63] to-[#B3CFE5] p-[1.5px]">
