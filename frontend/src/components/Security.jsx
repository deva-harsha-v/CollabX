...
const Security = () => {
  return (
    ...
    >
      {/* Glow effect */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-[#935073]/15 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <Reveal animation="fade-down">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#935073]/80 border border-[#935073]/40 text-[#F6DBC0] text-xs font-mono uppercase tracking-wider mb-4 shadow-md backdrop-blur-md">
              <ShieldCheck className="w-3.5 h-3.5 text-[#F6DBC0]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <Reveal animation="scale-in" delay={150} className="h-full">
            <div className="h-full p-8 rounded-3xl bg-[#935073]/80 border border-[#935073]/30 hover:border-[#935073]/60 transition-all duration-300 hover:-translate-y-2 group backdrop-blur-xl shadow-xl flex flex-col justify-between">
              <div>
                <div className="w-16 h-16 rounded-2xl bg-[#935073]/20 border border-[#935073]/40 flex items-center justify-center text-[#F6DBC0] mb-6 group-hover:scale-110 transition-all">
                  <FileCheck2 className="w-8 h-8" />
                </div>

                <div className="flex items-center gap-2 mb-3">
                  <span className="text-xs font-mono uppercase text-[#F6DBC0] font-bold tracking-wider">
                    Requirement 01
                  </span>
                </div>

                <h3 className="font-['Outfit'] font-bold text-2xl text-[#F8F4E9] mb-3 group-hover:text-[#F6DBC0] transition-colors">
              ...
              <div className="space-y-2 pt-4 border-t border-[#935073]/25 text-xs text-[#F6DBC0]/80">
        ...
        <Reveal animation="fade-up" delay={550}>
          <div className="p-8 rounded-3xl bg-gradient-to-r from-[#502D55] via-[#935073] to-[#502D55] border border-[#935073]/40 flex flex-col lg:flex-row items-center justify-between gap-8 backdrop-blur-xl shadow-2xl">
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-[#935073]/20 border border-[#935073]/40 flex items-center justify-center text-[#F6DBC0] shrink-0">
                <Fingerprint className="w-8 h-8" />
              </div>
              <div>
                <h4 className="text-xl font-bold text-[#F8F4E9] font-['Outfit']">End-to-End Cryptographic Handshake</h4>
                <p className="text-sm text-[#F6DBC0] max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-mono">
              <div className="px-4 py-2 rounded-xl bg-[#502D55] border border-[#935073]/40 text-[#F6DBC0]">
                <span>KYC Standard: LEVEL-3 ACADEMIC</span>
              </div>
              <div className="px-4 py-2 rounded-xl bg-[#502D55] border border-[#935073]/40 text-[#F8F4E9]">
