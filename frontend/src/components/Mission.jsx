...
const Mission = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[450px] bg-[#1A3D63]/15 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <Reveal animation="fade-up" delay={150}>
            <h2 className="font-['Outfit'] font-extrabold text-3xl sm:text-5xl md:text-6xl text-[#F6FAFD] tracking-tight leading-tight mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1A3D63] to-[#B3CFE5]">
                Right Minds
              </span>
            </h2>
          </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Reveal animation="fade-up" delay={100} className="h-full">
            <div className="relative h-full p-8 rounded-3xl bg-[#1A3D63]/80 border border-[#1A3D63]/30 hover:border-[#1A3D63]/60 transition-all duration-300 hover:-translate-y-2 group shadow-xl backdrop-blur-xl">
              <div className="w-14 h-14 rounded-2xl bg-[#1A3D63]/20 border border-[#1A3D63]/40 flex items-center justify-center text-[#B3CFE5] mb-6 group-hover:scale-110 transition-all">
              ...
              <div className="pt-4 border-t border-[#1A3D63]/25 flex items-center justify-between text-xs text-[#B3CFE5]/70 font-mono">
          ...
          <Reveal animation="fade-up" delay={400} className="h-full">
            <div className="relative h-full p-8 rounded-3xl bg-gradient-to-b from-[#1A3D63] to-[#0A1931] border border-[#1A3D63]/40 hover:border-[#B3CFE5]/60 transition-all duration-300 hover:-translate-y-2 group shadow-[0_10px_40px_rgba(74, 127, 167,0.2)] backdrop-blur-xl">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#1A3D63]/30 to-[#B3CFE5]/20 border border-[#B3CFE5]/40 flex items-center justify-center text-[#F6FAFD] mb-6 group-hover:scale-110 transition-all">
                <Network className="w-7 h-7" />
              </div>

              <span className="text-xs font-mono uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#1A3D63] to-[#B3CFE5] font-bold block mb-2">
        ...
        <Reveal animation="fade-in" delay={500} className="mt-16">
          <div className="p-6 rounded-2xl bg-[#1A3D63]/60 border border-[#1A3D63]/30 flex flex-wrap items-center justify-around gap-6 text-center backdrop-blur-md">
