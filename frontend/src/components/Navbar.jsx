    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ease-in-out ${
          isScrolled
            ? 'py-0 px-0 bg-[#06142e]/95 backdrop-blur-2xl border-b border-[#0ea5e9]/30 shadow-[0_4px_30px_rgba(0,0,0,0.8)]'
        ...
        >
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-[#38bdf8]">
            {currentUser ? (
                ...
                <Link
                  ...
                  className={`font-semibold flex items-center gap-1.5 transition-colors pb-0.5 ${
                    location.pathname === '/feed'
                      ? 'text-[#f0f9ff] border-b border-[#0ea5e9]'
                      : 'text-[#38bdf8] hover:text-[#f0f9ff]'
                  }`}
                >
                  <Sparkles className="w-4 h-4 text-[#38bdf8]" /> Live Feed
                </Link>
                <Link
                  to="/messages"
              ...
              <>
                <Link to="/" className="hover:text-[#f0f9ff] transition-all duration-300 border-b border-transparent hover:border-[#0ea5e9]/60 pb-0.5">The Mission</Link>
                <a href="#how-it-works" className="hover:text-[#f0f9ff] transition-all duration-300 border-b border-transparent hover:border-[#0ea5e9]/60 pb-0.5">How It Works</a>
                <a href="#security" className="hover:text-[#f0f9ff] transition-all duration-300 border-b border-transparent hover:border-[#0ea5e9]/60 pb-0.5">Security & Trust</a>
              </>
            )}
          </nav>
            ...
            <div className="flex items-center gap-2.5 sm:gap-3">
              ...
              <div className="relative" ref={notifRef}>
                <button
                  ...
                  className="relative p-2 rounded-xl bg-[#06142e]/80 hover:bg-[#0b2240] border border-[#0ea5e9]/30 text-[#38bdf8] hover:text-[#f0f9ff] transition-colors"
                ...
                {showNotifMenu && (
                  <div className="absolute right-0 mt-2 w-80 p-4 bg-[#0b2240]/95 border border-[#0ea5e9]/40 rounded-2xl backdrop-blur-2xl shadow-2xl z-50 text-xs">
                    <div className="flex items-center justify-between pb-2 mb-3 border-b border-[#0ea5e9]/30">
                      <span className="font-bold text-[#f0f9ff] font-['Outfit'] text-sm">Notifications</span>
                      <span className="text-[10px] font-mono text-[#38bdf8] font-semibold uppercase">
                    ...
                    {notifications.length > 0 ? (
                      <div className="space-y-2.5 max-h-64 overflow-y-auto pr-1">
                        {notifications.map((n) => (
                          <div
                            ...
                            className="p-2.5 rounded-xl bg-[#06142e]/80 hover:bg-[#0ea5e9]/20 border border-[#0ea5e9]/30 flex items-start gap-2.5 cursor-pointer transition-colors"
                          >
                            <span className={`w-2 h-2 rounded-full shrink-0 mt-1 ${n.read ? 'bg-[#0ea5e9]/50' : 'bg-red-400 shadow-[0_0_6px_#f87171]'}`} />
                            <div className="flex-1">
                              <p className="text-[#f0f9ff] font-medium leading-snug">
                                {n.message || n.payload?.message || 'New Notification'}
                              </p>
                              <span className="text-[10px] text-[#38bdf8]/70 font-mono mt-1 block">
                      ...
                      <div className="py-6 text-center text-[#38bdf8]/70 font-mono">
              ...
              <div className="relative" ref={profileRef}>
                <button
                  ...
                  className="flex items-center gap-2 p-1 pl-1.5 pr-2.5 rounded-full bg-[#06142e]/80 hover:bg-[#0b2240] border border-[#0ea5e9]/40 text-[#f0f9ff] transition-all group"
                >
                  <div className="w-7 h-7 rounded-full overflow-hidden border border-[#0ea5e9]/60 bg-[#0b2240] shrink-0">
                    <img
                  ...
                  <span className="text-xs font-semibold text-[#f0f9ff] max-w-[100px] truncate hidden sm:inline">
                    {currentUser.name}
                  </span>
                  <ChevronDown className="w-3.5 h-3.5 text-[#38bdf8] group-hover:text-[#f0f9ff] transition-colors" />
                </button>
                ...
                {showProfileMenu && (
                  <div className="absolute right-0 mt-2 w-48 py-2 bg-[#0b2240]/95 border border-[#0ea5e9]/40 rounded-2xl backdrop-blur-2xl shadow-2xl z-50 text-xs">
                    ...
                    <button
                      ...
                      className="w-full px-3.5 py-2 text-left text-[#38bdf8] hover:text-[#f0f9ff] hover:bg-[#0ea5e9]/30 flex items-center gap-2 transition-colors font-medium"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3.5 py-2 text-left text-[#38bdf8] hover:text-[#f0f9ff] hover:bg-[#0ea5e9]/30 flex items-center justify-between transition-colors font-medium"
                    >
                    ...
                    <button
                      ...
                      className="w-full px-3.5 py-2 text-left text-red-300 hover:text-red-200 hover:bg-red-950/40 flex items-center gap-2 transition-colors font-medium border-t border-[#0ea5e9]/30 mt-1"
                    >
          ...
          <button
            ...
            className="md:hidden p-2 rounded-xl bg-[#06142e]/80 hover:bg-[#0b2240] border border-[#0ea5e9]/30 text-[#38bdf8] hover:text-[#f0f9ff] transition-colors"
            aria-label="Toggle mobile menu"
          >
            {showMobileNav ? <X className="w-5 h-5 text-[#38bdf8]" /> : <Menu className="w-5 h-5 text-[#38bdf8]" />}
          </button>
        </div>

        {/* Mobile Navigation Drawer */}
        {showMobileNav && (
          <div className="md:hidden mx-4 mt-2 p-4 bg-[#0b2240]/95 border border-[#0ea5e9]/40 rounded-2xl backdrop-blur-2xl shadow-2xl flex flex-col gap-3 text-sm text-[#f0f9ff] animate-fade-in">
            {currentUser ? (
              <>
                <Link
                  to="/feed"
                  onClick={() => { setFeedFilter('all'); setShowMobileNav(false); }}
                  className="py-2 px-3 rounded-lg text-[#f0f9ff] font-semibold bg-[#0ea5e9]/30 border border-[#0ea5e9]/50 flex items-center gap-2"
                >
                  <Sparkles className="w-4 h-4 text-[#38bdf8]" /> Live Feed
                </Link>
                <Link
                  ...
                  className="py-2 px-3 rounded-lg text-[#f0f9ff] font-semibold bg-[#0ea5e9]/20 border border-[#0ea5e9]/40 flex items-center justify-between"
                >
                  <div className="flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-[#38bdf8]" />
                    <span>Messages</span>
              ...
              <>
                <Link 
                  to="/" 
                  onClick={() => setShowMobileNav(false)}
                  className="py-2 px-3 rounded-lg hover:bg-[#0ea5e9]/30 hover:text-[#f0f9ff] transition-colors"
                >
                  The Mission
                </Link>
                <a 
