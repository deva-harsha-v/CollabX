...
const AuthPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-[#0A1931] cyber-grid overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#1A3D63]/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <Link to={currentUser ? "/feed" : "/"} className="relative z-10 flex items-center gap-3 mb-8 group">
        <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#1A3D63] to-[#B3CFE5] p-[1.5px] shadow-lg shadow-[#1A3D63]/20 group-hover:scale-105 transition-transform duration-300">
        ...
        <div className="flex flex-col">
          <span className="font-['Outfit'] font-black text-2xl tracking-tight text-[#F6FAFD] flex items-center">
            Collab<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1A3D63] to-[#B3CFE5]">X</span>
          </span>
      ...
      {/* Auth Card Shell */}
      <div className="relative z-10 w-full max-w-md p-8 bg-[#1A3D63]/90 border border-[#1A3D63]/40 rounded-3xl backdrop-blur-2xl shadow-[0_0_50px_rgba(74, 127, 167,0.25)]">
        
        {/* Toggle Mode Tabs */}
        <div className="grid grid-cols-2 gap-2 p-1.5 mb-6 bg-[#0A1931]/80 border border-[#1A3D63]/30 rounded-2xl">
          <button
            type="button"
            onClick={() => { setMode('signup'); setErrorMsg(''); }}
            className={`py-2.5 rounded-xl text-sm font-semibold transition-all ${
              mode === 'signup'
                ? 'bg-gradient-to-r from-[#1A3D63] to-[#1A3D63] text-[#F6FAFD] shadow-md border border-[#B3CFE5]/30'
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {mode === 'signup' && (
            <div className="flex items-center gap-4 mb-2">
              <div className="relative w-14 h-14 rounded-full border border-[#1A3D63]/40 bg-[#0A1931] overflow-hidden flex items-center justify-center shrink-0">
                {avatarPreview ? (
              ...
              <div className="flex-1">
                <label className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#0A1931] hover:bg-[#1A3D63] border border-[#1A3D63]/40 text-xs font-medium text-[#B3CFE5] hover:text-[#F6FAFD] cursor-pointer transition-colors">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-[#0A1931]/80 border border-[#1A3D63]/40 rounded-xl text-sm text-[#F6FAFD] placeholder:text-[#B3CFE5]/40 focus:outline-none focus:border-[#B3CFE5] transition-colors"
                />
              </div>
            </div>
          )}
          ...
          {mode === 'signup' && (
            <div className="pt-2">
              <div className="p-3.5 rounded-xl bg-[#0A1931]/60 border border-dashed border-[#1A3D63]/40 text-xs">
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="flex-1">
                    ...
                    <label className="mt-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#1A3D63] border border-[#1A3D63]/40 text-[11px] font-medium text-[#B3CFE5] hover:bg-[#1A3D63]/30 cursor-pointer transition-colors">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-[#0A1931] border border-[#1A3D63]/40 rounded-xl text-xs text-[#F6FAFD] placeholder:text-[#B3CFE5]/40 focus:outline-none focus:border-red-400 transition-colors font-mono"
                  />
                </div>
              </div>
