...
const steps = [
  {
    ...
    icon: FileText,
    microCard: (
      <div className="mt-4 p-4 rounded-xl bg-[#502D55]/80 border border-[#935073]/30 text-xs">
        <div className="flex items-center justify-between text-[#F6DBC0] font-mono text-[11px] mb-2">
          <span>Brief ID: #CX-POST-014</span>
          <span className="px-2 py-0.5 rounded bg-[#935073] text-[#F8F4E9]">Public RFP</span>
        </div>
        <div className="font-semibold text-[#F8F4E9]">Urban Heat Island Mitigation & Tree Canopy Optimization</div>
        <div className="flex gap-2 mt-2 text-[10px] text-[#F6DBC0]/80 font-mono">
          <span className="bg-[#935073]/60 px-2 py-1 rounded">GIS Data Included</span>
          <span className="bg-[#935073]/60 px-2 py-1 rounded">60-Day Target</span>
        </div>
      </div>
    ),
  },
    ...
    microCard: (
      <div className="mt-4 p-4 rounded-xl bg-[#502D55]/80 border border-[#935073]/30 text-xs">
        <div className="flex items-center justify-between text-[#F6DBC0] font-mono text-[11px] mb-2">
          ...
          <span className="flex items-center gap-1 text-[#F8F4E9] font-bold">
            <ShieldCheck className="w-3 h-3 text-[#F6DBC0]" /> ORCID Verified
          </span>
        </div>
        <div className="text-[#F8F4E9] font-medium">Department of Climate Informatics & Urban Sensing</div>
        <div className="mt-2 text-[10px] text-[#F6DBC0]/80 flex items-center gap-2">
  ...
  },
  {
    ...
    microCard: (
      <div className="mt-4 p-4 rounded-xl bg-[#502D55]/80 border border-[#935073]/30 text-xs">
        ...
        <div className="space-y-1.5 text-[11px] text-[#F6DBC0]">
  ...
  },
  {
    ...
    microCard: (
      <div className="mt-4 p-4 rounded-xl bg-[#502D55]/80 border border-[#935073]/30 text-xs">
        <div className="flex justify-between text-xs text-[#F8F4E9] mb-1.5">
          <span>Resolution Milestones</span>
          <span className="font-mono text-[#F6DBC0] font-bold">75% Complete</span>
        </div>
        <div className="w-full h-2 bg-[#935073] rounded-full overflow-hidden">
          <div className="w-3/4 h-full bg-gradient-to-r from-[#935073] to-[#F6DBC0] rounded-full" />
        </div>
        <div className="mt-2.5 flex justify-between text-[10px] text-[#F6DBC0]/80 font-mono">
          <span>Phase 3: Sensor Array Live</span>
          <span className="text-[#F8F4E9]">Deploying in 12 Days</span>
        </div>
      </div>
    ),
  },
...
const HowItWorks = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#935073]/25 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                <div className="relative h-full flex flex-col justify-between p-6 rounded-3xl bg-[#935073]/80 border border-[#935073]/30 hover:border-[#935073]/60 transition-all duration-300 hover:-translate-y-2 group backdrop-blur-xl shadow-xl">
                  {/* Step Header */}
                  <div>
                    <div className="flex items-center justify-between mb-5">
                      ...
                      <div className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all group-hover:scale-110 bg-[#935073]/20 text-[#F6DBC0] border border-[#935073]/40">
                    ...
                    <p className="text-xs text-[#F6DBC0]/90 leading-relaxed">
                      {step.desc}
                    </p>
                  </div>
                  ...
                  {idx < steps.length - 1 && (
                    <div className="hidden lg:block absolute -right-3 top-1/2 -translate-y-1/2 z-20">
                      <div className="w-6 h-6 rounded-full bg-[#935073] border border-[#935073]/50 flex items-center justify-center text-[#F6DBC0] shadow-lg">
