...
const ChatRoomModal = ({ postId, postTitle, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-[95vw] sm:w-full max-w-2xl h-[90vh] sm:h-[80vh] flex flex-col bg-[#1A3D63]/95 border border-[#4A7FA7]/40 rounded-3xl shadow-[0_0_60px_rgba(74,127,167,0.3)] text-[#F6FAFD] overflow-hidden backdrop-blur-2xl">
        
        {/* Glow ambient */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#4A7FA7]/15 rounded-full blur-3xl pointer-events-none" />

        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-[#4A7FA7]/30 flex items-center justify-between bg-[#0A1931]/80 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-[#4A7FA7]/20 border border-[#4A7FA7]/40 flex items-center justify-center text-[#B3CFE5]">
            ...
            <div>
              <h3 className="text-lg font-bold font-['Outfit'] text-[#F6FAFD] flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono text-[#F6FAFD] bg-[#0A1931] px-2 py-0.5 rounded border border-[#4A7FA7]/40 font-bold">
                  REALTIME
                </span>
              </h3>
          ...
          {loading ? (
            ...
            messages.map((msg) => {
              ...
              return (
                ...
                >
                  <div className="w-8 h-8 rounded-full overflow-hidden border border-[#4A7FA7]/40 bg-[#0A1931] shrink-0 mt-1">
        ...
        {/* Input Bar */}
        <form onSubmit={handleSendMessage} className="p-3 sm:p-4 bg-[#0A1931] border-t border-[#4A7FA7]/30 flex items-center gap-2 shrink-0">
