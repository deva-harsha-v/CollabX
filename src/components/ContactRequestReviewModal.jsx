...
const ContactRequestReviewModal = ({ notification, isOpen, onClose, onRefresh }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-[95vw] sm:w-full max-w-lg max-h-[90vh] overflow-y-auto p-5 sm:p-8 bg-[#935073]/95 border border-[#935073]/40 rounded-3xl shadow-[0_0_60px_rgba(147, 80, 115,0.3)] text-[#F8F4E9] backdrop-blur-2xl">
        ...
        {/* Solver Card */}
        <div className="p-4 rounded-2xl bg-[#502D55]/80 border border-[#935073]/30 flex items-center gap-3 mb-5">
          <div className="w-12 h-12 rounded-full overflow-hidden border border-[#935073]/40 bg-[#502D55] shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-[#F6DBC0]/80 font-mono">
              Request for: <span className="text-[#F8F4E9] font-semibold">{payload.post_title || 'Open Challenge'}</span>
            </p>
          </div>
        </div>

        {/* Time-Limited Verification Document Access */}
        <div className="p-4 rounded-2xl bg-[#502D55]/80 border border-[#935073]/40 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-[#F8F4E9] bg-[#935073] px-2 py-0.5 rounded border border-[#935073]/40 font-bold">
              60s Signed URL
            </span>
          </div>
          ...
          {loadingDoc ? (
            ...
            <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-[#935073]/80 border border-[#935073]/40">
            ...
            <p className="text-xs text-[#F6DBC0]/70 font-mono py-2 text-center">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="py-3 px-4 rounded-xl bg-[#502D55] hover:bg-[#935073] border border-[#935073]/30 text-[#F6DBC0] text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50"
          >
            <XCircle className="w-4 h-4 text-[#F6DBC0]/60" />
          ...
          <button
            ...
            className="py-3 px-4 rounded-xl bg-gradient-to-r from-[#935073] to-[#935073] hover:from-[#935073]/80 hover:to-[#935073]/80 text-[#F8F4E9] text-xs font-bold border border-[#F6DBC0]/30 flex items-center justify-center gap-1.5 transition-all shadow-lg disabled:opacity-50"
          >
