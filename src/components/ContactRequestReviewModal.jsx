...
const ContactRequestReviewModal = ({ notification, isOpen, onClose, onRefresh }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-[95vw] sm:w-full max-w-lg max-h-[90vh] overflow-y-auto p-5 sm:p-8 bg-[#1A3D63]/95 border border-[#4A7FA7]/40 rounded-3xl shadow-[0_0_60px_rgba(74,127,167,0.3)] text-[#F6FAFD] backdrop-blur-2xl">
        ...
        {/* Solver Card */}
        <div className="p-4 rounded-2xl bg-[#0A1931]/80 border border-[#4A7FA7]/30 flex items-center gap-3 mb-5">
          <div className="w-12 h-12 rounded-full overflow-hidden border border-[#4A7FA7]/40 bg-[#0A1931] shrink-0">
        ...
        <div className="p-4 rounded-2xl bg-[#0A1931]/80 border border-[#4A7FA7]/40 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[10px] font-mono text-[#F6FAFD] bg-[#1A3D63] px-2 py-0.5 rounded border border-[#4A7FA7]/40 font-bold">
              60s Signed URL
            </span>
          </div>
          ...
          {loadingDoc ? (
            ...
            <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-[#1A3D63]/80 border border-[#4A7FA7]/40">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-[#0A1931] hover:bg-[#1A3D63] border border-[#4A7FA7]/40 text-[#B3CFE5] text-xs font-semibold transition-colors shrink-0"
              >
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="py-3 px-4 rounded-xl bg-[#0A1931] hover:bg-[#1A3D63] border border-[#4A7FA7]/30 text-[#B3CFE5] text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50"
          >
          ...
          <button
            ...
            className="py-3 px-4 rounded-xl bg-gradient-to-r from-[#4A7FA7] to-[#1A3D63] hover:from-[#4A7FA7]/80 hover:to-[#1A3D63]/80 text-[#F6FAFD] text-xs font-bold border border-[#B3CFE5]/30 flex items-center justify-center gap-1.5 transition-all shadow-lg disabled:opacity-50"
          >
