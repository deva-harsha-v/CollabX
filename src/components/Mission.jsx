...
const Mission = () => {
  return (
    <section 
      id="mission" 
      className="relative min-h-screen py-28 flex flex-col justify-center items-center bg-[#502D55] border-t border-[#935073]/20"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 w-full">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <Reveal animation="fade-down">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#935073]/80 border border-[#935073]/40 text-[#F6DBC0] text-xs font-mono uppercase tracking-wider mb-4 shadow-md backdrop-blur-md">
          ...
          <Reveal animation="fade-up" delay={150}>
            <h2 className="font-['Outfit'] font-extrabold text-3xl sm:text-5xl md:text-6xl text-[#F8F4E9] tracking-tight leading-tight mb-6">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#935073] to-[#F6DBC0]">
                Right Minds
              </span>
            </h2>
          </Reveal>
          ...
          <Reveal animation="fade-up" delay={250}>
            <p className="text-base sm:text-lg text-[#F6DBC0] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Reveal animation="fade-up" delay={100} className="h-full">
            <div className="relative h-full p-8 rounded-3xl bg-[#935073]/80 border border-[#935073]/30 hover:border-[#935073]/60 transition-all duration-300 hover:-translate-y-2 group shadow-xl backdrop-blur-xl">
              <div className="w-14 h-14 rounded-2xl bg-[#935073]/20 border border-[#935073]/40 flex items-center justify-center text-[#F6DBC0] mb-6 group-hover:scale-110 transition-all">
              ...
              <p className="text-sm text-[#F6DBC0]/90 leading-relaxed mb-6">
              ...
              <div className="pt-4 border-t border-[#935073]/25 flex items-center justify-between text-xs text-[#F6DBC0]/70 font-mono">
                <span>Stalled Initiatives:</span>
                <span className="font-bold text-[#F8F4E9]">84% Lack Specialized Teams</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal animation="fade-up" delay={250} className="h-full">
            <div className="relative h-full p-8 rounded-3xl bg-[#935073]/80 border border-[#935073]/30 hover:border-[#935073]/60 transition-all duration-300 hover:-translate-y-2 group shadow-xl backdrop-blur-xl">
              ...
              <div className="pt-4 border-t border-[#935073]/25 flex items-center justify-between text-xs text-[#F6DBC0]/70 font-mono">
                ...
                <span className="font-bold text-[#F8F4E9]">2.5M+ Papers Untested in Field</span>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal animation="fade-up" delay={400} className="h-full">
            <div className="relative h-full p-8 rounded-3xl bg-gradient-to-b from-[#935073] to-[#502D55] border border-[#935073]/40 hover:border-[#F6DBC0]/60 transition-all duration-300 hover:-translate-y-2 group shadow-[0_10px_40px_rgba(147, 80, 115,0.2)] backdrop-blur-xl">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#935073]/30 to-[#F6DBC0]/20 border border-[#F6DBC0]/40 flex items-center justify-center text-[#F8F4E9] mb-6 group-hover:scale-110 transition-all">
                <Network className="w-7 h-7" />
              </div>

              <span className="text-xs font-mono uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#935073] to-[#F6DBC0] font-bold block mb-2">
              ...
              <div className="pt-4 border-t border-[#935073]/25 flex items-center justify-between text-xs text-[#F6DBC0]/70 font-mono">
                ...
                <span className="font-bold text-[#F8F4E9]">Under 72 Hours</span>
              </div>
            </div>
          </Reveal>
        </div>
        ...
        <Reveal animation="fade-in" delay={500} className="mt-16">
          <div className="p-6 rounded-2xl bg-[#935073]/60 border border-[#935073]/30 flex flex-wrap items-center justify-around gap-6 text-center backdrop-blur-md">
