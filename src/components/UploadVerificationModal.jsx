...
const UploadVerificationModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-[95vw] sm:w-full max-w-lg max-h-[90vh] overflow-y-auto p-5 sm:p-8 bg-[#0c1322] border border-cyan-500/30 rounded-3xl shadow-[0_0_50px_rgba(6,182,212,0.25)] text-slate-100">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="text-xl font-bold font-['Outfit'] text-white">Verification Document Required</h3>
            <p className="text-xs text-cyan-400 font-mono tracking-wider uppercase">CollabX Trust Architecture</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="p-4 rounded-2xl bg-slate-950/70 border border-dashed border-cyan-500/40 flex flex-col items-center justify-center text-center">
            ...
            <label className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-cyan-950 hover:bg-cyan-900 border border-cyan-500/30 text-xs font-medium text-cyan-300 cursor-pointer transition-colors">
