...
const UploadVerificationModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-[95vw] sm:w-full max-w-lg max-h-[90vh] overflow-y-auto p-5 sm:p-8 bg-[#1A3D63]/95 border border-[#4A7FA7]/40 rounded-3xl shadow-[0_0_50px_rgba(74,127,167,0.3)] text-[#F6FAFD] backdrop-blur-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="p-4 rounded-2xl bg-[#0A1931]/80 border border-dashed border-[#4A7FA7]/40 flex flex-col items-center justify-center text-center">
            ...
            <label className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#1A3D63] hover:bg-[#244b78] border border-[#4A7FA7]/40 text-xs font-medium text-[#B3CFE5] cursor-pointer transition-colors">
