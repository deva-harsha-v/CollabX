...
const Security = () => {
  return (
    ...
    >
      {/* Glow effect */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-[#4A7FA7]/15 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <Reveal animation="scale-in" delay={150} className="h-full">
            <div className="h-full p-8 rounded-3xl bg-[#1A3D63]/80 border border-[#4A7FA7]/30 hover:border-[#4A7FA7]/60 transition-all duration-300 hover:-translate-y-2 group backdrop-blur-xl shadow-xl flex flex-col justify-between">
              <div>
                <div className="w-16 h-16 rounded-2xl bg-[#4A7FA7]/20 border border-[#4A7FA7]/40 flex items-center justify-center text-[#B3CFE5] mb-6 group-hover:scale-110 transition-all">
              ...
              <div className="space-y-2 pt-4 border-t border-[#4A7FA7]/25 text-xs text-[#B3CFE5]/80">
        ...
        <Reveal animation="fade-up" delay={550}>
          <div className="p-8 rounded-3xl bg-gradient-to-r from-[#0A1931] via-[#1A3D63] to-[#0A1931] border border-[#4A7FA7]/40 flex flex-col lg:flex-row items-center justify-between gap-8 backdrop-blur-xl shadow-2xl">
            <div className="flex items-center gap-5">
              <div className="w-14 h-14 rounded-2xl bg-[#4A7FA7]/20 border border-[#4A7FA7]/40 flex items-center justify-center text-[#B3CFE5] shrink-0">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs font-mono">
              <div className="px-4 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-[#B3CFE5]">
                <span>KYC Standard: LEVEL-3 ACADEMIC</span>
              </div>
              <div className="px-4 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-[#F6FAFD]">
