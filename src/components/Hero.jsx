        ...
        <div className="w-full lg:w-[48%] max-w-[540px] text-left flex flex-col items-start my-auto">
          ...
          <Reveal animation="scale-in" delay={400}>
            <div className="flex flex-row items-center gap-4 sm:gap-5 justify-start flex-wrap">
              ...
              <a
                href="#how-it-works"
                className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#1A3D63]/80 hover:bg-[#244b78] border border-[#4A7FA7]/40 text-[#F6FAFD] font-['Outfit'] font-semibold text-sm sm:text-base transition-all hover:border-[#4A7FA7]/70 shadow-lg"
              >
