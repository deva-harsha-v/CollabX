            ...
            {activeTab === 'problems' && (
              <div className="space-y-4">
                ...
                {filteredPosts.map((post) => (
                  <div
                    key={post.id}
                    className="p-5 rounded-2xl bg-[#1A3D63]/80 border border-[#4A7FA7]/30 hover:border-red-500/50 transition-all backdrop-blur-xl shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4 group"
                  >
                    <div 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {filteredUsers.map((user) => {
                  ...
                  return (
                    <div
                      key={user.id}
                      className="p-5 rounded-2xl bg-[#1A3D63]/80 border border-[#4A7FA7]/30 hover:border-red-500/40 backdrop-blur-xl shadow-lg flex flex-col justify-between transition-all group"
                    >
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-3">
                          <div className="p-2 rounded-xl bg-[#0A1931]/80 border border-[#4A7FA7]/30 text-center">
            ...
            {activeTab === 'chatrooms' && (
              <div className="space-y-4">
                ...
                {filteredRooms.map((room) => (
                  <div
                    key={room.id}
                    className="p-5 rounded-2xl bg-[#1A3D63]/80 border border-[#4A7FA7]/30 hover:border-red-500/40 backdrop-blur-xl shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-4"
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 mb-1">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 bg-[#1A3D63]/95 border-2 border-red-500/40 rounded-3xl shadow-[0_0_50px_rgba(239,68,68,0.3)] text-[#F6FAFD]">
            <button
              ...
              className="sticky top-0 float-right z-30 p-2 text-[#B3CFE5] hover:text-[#F6FAFD] rounded-full bg-[#0A1931]/80 border border-[#4A7FA7]/40 backdrop-blur-md"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {/* Poster Details Grid */}
            <div className="p-4 rounded-2xl bg-[#0A1931]/80 border border-[#4A7FA7]/30 text-xs font-mono space-y-2 mb-4">
              ...
              {selectedPost.latitude && selectedPost.longitude && (
                <div className="flex justify-between items-center flex-wrap gap-2 pt-1 border-t border-[#4A7FA7]/20">
              ...
              <div className="flex justify-between flex-wrap gap-2 pt-1 border-t border-[#4A7FA7]/20">
            ...
            <div className="mb-4">
              ...
              <div className="p-4 rounded-2xl bg-[#0A1931]/60 border border-[#4A7FA7]/20 text-xs text-[#F6FAFD] leading-relaxed whitespace-pre-line">
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedPost.skills.map((s) => (
                    <span key={s} className="px-2.5 py-1 rounded-lg bg-[#0A1931] border border-[#4A7FA7]/40 text-xs text-[#B3CFE5] font-mono">
                      {s}
                    </span>
                  ))}
                </div>
            ...
            {(selectedPost.media_url || selectedPost.media) && (
              <div className="mb-5">
                ...
                <div className="rounded-2xl overflow-hidden border border-[#4A7FA7]/40 max-h-64 bg-[#0A1931]">
                  <img
            ...
            {/* Footer Actions */}
            <div className="flex items-center justify-between gap-3 pt-4 border-t border-[#4A7FA7]/30">
              ...
              <button
                type="button"
                onClick={() => setSelectedPost(null)}
                className="px-5 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-xs font-semibold text-[#B3CFE5] hover:text-[#F6FAFD]"
              >
                Close
              </button>
            </div>
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
            <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 bg-[#1A3D63]/95 border-2 border-red-500/40 rounded-3xl shadow-[0_0_50px_rgba(239,68,68,0.3)] text-[#F6FAFD]">
                ...
                <div>
                  ...
                  <span className={`inline-flex items-center gap-1 text-[10px] font-mono font-bold mt-1 px-2 py-0.5 rounded-full ${
                    selectedUser.verification_uploaded
                      ? 'bg-emerald-950/80 border border-emerald-500/40 text-emerald-300'
                      : 'bg-[#0A1931] border border-[#4A7FA7]/30 text-[#B3CFE5]/60'
                  }`}>
              ...
              {/* User Data Telemetry */}
              <div className="p-4 rounded-2xl bg-[#0A1931]/80 border border-[#4A7FA7]/30 text-xs font-mono space-y-2 mb-6">
              ...
              <div className="mb-6">
                ...
                {userPosts.length > 0 ? (
                  <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                    {userPosts.map(p => (
                      <div key={p.id} className="p-3 rounded-xl bg-[#0A1931]/70 border border-[#4A7FA7]/30 flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-[#B3CFE5]/60 font-mono italic p-3 rounded-xl bg-[#0A1931]/40 border border-[#4A7FA7]/20">
              ...
              <div className="mb-6">
                ...
                {userIdeas.length > 0 ? (
                  <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                    {userIdeas.map(c => (
                      <div key={c.id || Math.random()} className="p-3 rounded-xl bg-[#0A1931]/70 border border-[#4A7FA7]/30 flex items-center justify-between gap-3">
                        <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center justify-between gap-3 pt-4 border-t border-[#4A7FA7]/30">
                ...
                <button
                  type="button"
                  onClick={() => setSelectedUser(null)}
                  className="px-5 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-xs font-semibold text-[#B3CFE5] hover:text-[#F6FAFD] ml-auto"
                >
                  Close
                </button>
              </div>
      ...
      {selectedRoom && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 sm:p-8 bg-[#1A3D63]/95 border-2 border-red-500/40 rounded-3xl shadow-[0_0_50px_rgba(239,68,68,0.3)] text-[#F6FAFD]">
            ...
            <div className="p-4 rounded-2xl bg-[#0A1931]/90 border border-[#4A7FA7]/30 min-h-[300px] max-h-[450px] overflow-y-auto space-y-3 mb-4">
              {loadingRoomMessages ? (
                ...
                roomMessages.map((msg) => (
                  <div key={msg.id} className="p-3 rounded-xl bg-[#1A3D63]/70 border border-[#4A7FA7]/30">
            ...
            <div className="flex justify-end pt-3 border-t border-[#4A7FA7]/30">
              <button
                type="button"
                onClick={() => setSelectedRoom(null)}
                className="px-5 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-xs font-semibold text-[#B3CFE5] hover:text-[#F6FAFD]"
      ...
      {previewDoc && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in">
          <div className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 bg-[#1A3D63]/95 border-2 border-red-500/40 rounded-3xl shadow-[0_0_50px_rgba(239,68,68,0.3)] text-[#F6FAFD]">
            ...
            <div className="p-4 rounded-2xl bg-[#0A1931] border border-[#4A7FA7]/30 flex items-center justify-center min-h-[350px] mb-4 overflow-hidden">
            ...
            <div className="flex items-center justify-between gap-3 pt-3 border-t border-[#4A7FA7]/30">
              <a
                href={previewDoc.url}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <form onSubmit={handleConfirmDeletePost} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-[#0A1931] border border-[#4A7FA7]/40 rounded-xl text-xs text-[#F6FAFD] placeholder:text-[#B3CFE5]/40 focus:outline-none focus:border-red-400 transition-colors"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setDeleteTargetPost(null)}
                  className="px-4 py-2 rounded-xl bg-[#0A1931] border border-[#4A7FA7]/40 text-xs font-semibold text-[#B3CFE5]"
                >
                  Cancel
                </button>
                <button
