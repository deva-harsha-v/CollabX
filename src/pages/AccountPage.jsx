    ...
    <div className="min-h-screen bg-[#0A1931] text-[#F6FAFD] cyber-grid relative">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-32">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#1A3D63] hover:bg-[#244b78] border border-[#4A7FA7]/40 text-[#B3CFE5] hover:text-[#F6FAFD] text-xs font-semibold mb-6 transition-all shadow-md"
        >
        ...
        {/* Page Header */}
        <div className="mb-8 border-b border-[#4A7FA7]/30 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-[#1A3D63]/80 border border-[#4A7FA7]/40 backdrop-blur-xl shadow-2xl flex flex-col justify-between">
            <div>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-[#4A7FA7] bg-[#0A1931] shrink-0">
                    <img
                      src={avatarPreview}
                      alt={name}
                  ...
                  <div>
                    <label className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#0A1931] hover:bg-[#1A3D63] border border-[#4A7FA7]/40 text-[#B3CFE5] hover:text-[#F6FAFD] text-xs font-semibold cursor-pointer transition-colors shadow-md">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-[#0A1931]/80 border border-[#4A7FA7]/40 rounded-xl text-xs text-[#F6FAFD] placeholder:text-[#B3CFE5]/40 focus:outline-none focus:border-[#B3CFE5] transition-colors font-medium"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled
                      className="w-full pl-10 pr-4 py-2.5 bg-[#0A1931]/40 border border-[#4A7FA7]/20 rounded-xl text-xs text-[#B3CFE5]/60 cursor-not-allowed font-mono"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-[#0A1931]/80 border border-[#4A7FA7]/40 rounded-xl text-xs text-[#F6FAFD] placeholder:text-[#B3CFE5]/40 focus:outline-none focus:border-[#B3CFE5] transition-colors font-mono"
                    />
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-[#4A7FA7] to-[#1A3D63] border border-[#B3CFE5]/30 text-[#F6FAFD] font-semibold text-xs transition-all shadow-md hover:scale-[1.02] disabled:opacity-50"
                  >
