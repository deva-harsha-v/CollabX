    ...
    <div className="min-h-screen bg-[#502D55] text-[#F8F4E9] cyber-grid relative">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-32">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#935073] hover:bg-[#244b78] border border-[#935073]/40 text-[#F6DBC0] hover:text-[#F8F4E9] text-xs font-semibold mb-6 transition-all shadow-md"
        >
        ...
        {/* Page Header */}
        <div className="mb-8 border-b border-[#935073]/30 pb-6">
          ...
          <h1 className="font-['Outfit'] font-extrabold text-3xl sm:text-4xl text-[#F8F4E9] tracking-tight">
            My Profile & Security
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-[#935073]/80 border border-[#935073]/40 backdrop-blur-xl shadow-2xl flex flex-col justify-between">
            <div>
              <h2 className="font-['Outfit'] font-bold text-xl text-[#F8F4E9] mb-6 flex items-center gap-2">
                <User className="w-5 h-5 text-[#F6DBC0]" />
              ...
              <form onSubmit={handleSaveProfile} className="space-y-5">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 border-[#935073] bg-[#502D55] shrink-0">
                    <img
                      src={avatarPreview}
                      alt={name}
                  ...
                  <div>
                    <label className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-[#502D55] hover:bg-[#935073] border border-[#935073]/40 text-[#F6DBC0] hover:text-[#F8F4E9] text-xs font-semibold cursor-pointer transition-colors shadow-md">
                      <Camera className="w-4 h-4 text-[#F6DBC0]" />
                      <span>Change Picture</span>
                      <input type="file" accept="image/*" onChange={handleAvatarChange} className="hidden" />
                    </label>
                    <p className="text-[10px] text-[#F6DBC0]/60 font-mono mt-1.5">PNG, JPG or WEBP up to 5MB</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-[#502D55]/80 border border-[#935073]/40 rounded-xl text-xs text-[#F8F4E9] placeholder:text-[#F6DBC0]/40 focus:outline-none focus:border-[#F6DBC0] transition-colors font-medium"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled
                      className="w-full pl-10 pr-4 py-2.5 bg-[#502D55]/40 border border-[#935073]/20 rounded-xl text-xs text-[#F6DBC0]/60 cursor-not-allowed font-mono"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#F6DBC0]/60" />
                    <input
                      type="tel"
                      value={phone}
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-[#935073] to-[#935073] border border-[#F6DBC0]/30 text-[#F8F4E9] font-semibold text-xs transition-all shadow-md hover:scale-[1.02] disabled:opacity-50"
                  >
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-[#935073]/80 border border-[#935073]/40 backdrop-blur-xl shadow-2xl flex flex-col justify-between">
            <div>
              <h2 className="font-['Outfit'] font-bold text-xl text-[#F8F4E9] mb-6 flex items-center gap-2">
                <KeyRound className="w-5 h-5 text-[#F6DBC0]" />
              ...
              <form onSubmit={handleChangePassword} className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#F6DBC0]/60 font-mono mt-1">
